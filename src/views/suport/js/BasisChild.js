...
const contenTc = {
    market: {
        name1: "外匯市場：當代發展最快的金融市場",
        name2: "",
        content: [
            "壹、外匯市場與期貨及股票市場的比較",
            "並不單單是在線外匯交易的興起促進了整個外匯市場的成交量。隨著外匯市場在過去數年波動性的提高，許多交易者也日益意識到外匯市場波動將影響股票市場和債券市場。因此，如果股票、債券和商品交易者們想要做出明智的交易決策，就必須追蹤和考慮外匯市場的變化。下面是壹些外匯市場波動影響股票和債券市場的歷史實例。",
            "歐元/美元匯率與公司利潤",
            "對於股票交易者，特別是投資那些大量出口美國的歐洲公司的交易者而言，密切關註匯率的變化對於預測公司的收益和利潤狀況是非常重要的。自從2003年開始，歐洲的制造商們就大肆抱怨歐元的升值和美元的貶值。導致美元走軟的罪魁禍首是美國快速增長的貿易赤字和預算赤字，也就是所謂的“雙赤字”問題。這個問題導致歐元兌美元匯率飆升，而這又使得歐元區出口給美國消費者的商品變得更加昂貴，最終導致歐元區公司的利潤下降。在2003年，由於德國大眾公司沒有進行充分的匯率對沖，造成了大約10億歐元的利潤損失，而荷蘭國家礦業公司，這家化工集團則警告說歐元兌美元匯率變動百分之壹會導致公司利潤損失700萬到1100萬歐元。不幸的是，不充分的匯率對沖在2008年的歐元區仍舊是壹個普遍存在的問題。因此，密切關註歐元兌美元的匯率變化對於預測歐元出口商們的收益和利潤水平是極其重要的。",
            "日經指數和美元",
            "參與日本股票的交易者們也需要註意美元走勢的變化，以及美元走勢如何影響日經走勢的漲落。日本最近已經經歷了長達十年的經濟停滯。在這期間，美國的共同基金和對沖基金大幅減持了日本股票。當日本經濟開始復苏的時候，這些基金爭搶著入場，他們對自己的投資組合進行了調整，以免錯失掉日本經濟復苏帶來的投資機會。對沖基金借入美元以便買入日本股票，增加持有的日本股票敞口。不過，這樣做卻使得他們對於美元利率變化極端敏感，對於美聯儲貨幣政策是否進入緊縮周期非常敏感。美元借貸成本的上升會打擊日經指數的上揚走勢，因為更高的利率會提高美元貸款的融資成本。美國經常擁有巨大的項目赤字，美聯儲為了維持和增加美元資產的吸引力就必須持續提高利率水平。因此，持續的加息伴隨著日本經濟的低速增長或許會使得基金過度融資買入日本股票的行為變得無利可圖。因此，美元的變動對於日經指數的漲跌具有重要的影響。",
            "二、外匯市場與期貨及股票市場的比較",
            "傳統意義上來說，外匯市場並不為大眾所追棒，因為管制、資本要求和技術等方面的原因，使得最初能夠參與外匯市場的主體被局限於對沖基金和商品交易管理顧問基金這類管理大量資金的金融機構，以及大公司和其他機構。傳統的外匯市場之所以被局限於這些大型機構，主要原因是交易者承擔的風險完全是個性化的。換言之，壹個交易者可能采納了壹百倍的杠桿，而與此同時另外壹個交易者卻沒有采用任何杠桿。但是，最近幾年許多公司開始向散戶(零售小額交易者)提供進入外匯市場的途徑。這些公司向散戶交易者提供交易融資和杠桿，免費的即時執行交易平臺、行情圖表和實時新聞等。這就使得外匯作為可選的交易標的的吸引力大大上升了，而外匯交易也因此變得大眾化。<br><br>許多股票和期貨交易者已經將外匯加入到他們的交易對象池中，或者轉向只交易外匯。之所以出現了這樣的趨勢，是因為這些交易者開始意識到外匯與股票和期貨相比具有更多的吸引力。</p>",
            "外匯與股票比較",
            "外匯現貨交易與證券股票交易相比具有如下區別：",
            "外匯市場的主要特征",
            "外匯市場是全球最大的金融市場，並且成交量和流動性還在不停地增長。",
            "外匯市場是全天候的24小時交易市場。",
            "交易者既可以從上漲走勢中賺取利潤，又可以從下跌走勢中賺取利潤。",
            "不存在交易限制。",
            "立即執行的交易平臺最小化了成交滑移點差和錯誤。",
            "即使存在更高交易杠桿帶來更高風險的問題，許多交易者仍舊認為外匯市場是壹個“物有所值”的市場。",
            "股票市場的主要特征",
            "市場流動水平壹般，主要依賴於股票日成交量。",
            "市場運行從紐約時間上午9:30持續到下午4點，盤後的場外電子盤交易時間存在限制。",
            "現有的成交和交割費用，以及傭金較高。",
            "存在上漲方能拋空的規則，也就是必須在上漲中賣空，這令日內交易者受到極大的制約。交易限制或許也對日內交易者產生了負面影響。",
            "完成交易涉及的步驟太多，以至於增加了成交滑移和錯誤的幾率。",
            "外匯市場是全球最具流動性的市場，其巨大的成交量和極高的流動性允許交易者們能夠以較低的交易成本和較高的杠桿參與其中。這是壹個24小時運作的市場，無論牛熊市都能賺錢，錯誤率和成交滑移價差都被最小化，沒有交易限制和上漲拋空的規定。交易者們可以運用與股票市場中采納的壹樣的分析技巧來研究外匯市場。對於基本面交易者而言，可以像分析股壹樣分析國家，對於技術面交易者面言，外匯市場是壹個使用技術分析的理想市場，因為專業交易者們已經在廣泛地采用各種技術分析工具。為了更好地明白外匯市場為什麽具有如此的吸引力，為什麽如此值得我們去參與其中，我們應該更進壹步深入地了解外匯市場的特征。",
            "外匯與期貨比較",
            "外匯市場的主要特征",
            "它是全球最大的市場，並且流動性還在增長。",
            "24小時全天候交易。",
            "無論牛市還是熊市都存在獲利機會。",
            "沒有上漲方能做空的限制。",
            "即時執行的交易平臺最小化了成交滑移價差和其他錯誤。",
            "雖然較高的杠桿水平增加了風險，但許多交易者則認為外匯市場帶來了更高的潛在收益。",
            "期貨市場的主要特征",
            "市場流動性有限，依賴於各月份交易合約的流動性。",
            "交易清算費用和傭金導致更高的交易成本。",
            "期貨交易的開市時間短於現貨外匯市場，並且取決於交易品種;每個交易品種或許有不同的開盤和收盤時間，盤後交易時間存在限制。",
            "期貨的交易杠桿高於證券，但是遠遠不及外匯交易中可以運用的杠桿水平。",
            "通常情況下，期貨市場中熊市持續的時間較長。",
            "場內交易的構架增加了成交滑移價差和其他錯誤的概率。",
            "正如股票市場上許多分析和交易策略可以運用於外匯市場壹樣，期貨市場中的策略也可以運用到外匯交易中。絕大多數期貨交易者都運用技術分析手段，正如之前在股票對比部分提到的壹樣，外匯市場是運用技術分析的理想場合。實際上，技術分析是職業交易者們運用最普遍的分析工具。",
            "三、外匯交易的不同途徑",
            "外匯現貨",
            "外匯期貨",
            "外匯期權",
    ...
    first: {
        name: "初識外匯——外匯基礎知識",
        content: [
            "外匯交易員從來不會只買賣壹種貨幣，市場運行的方式亦是如此。他們先賣出壹種貨幣，再用這筆錢買進另壹種貨幣。總之，貨幣不會被單獨交易。",
            "思考壹下，1美元值多少錢？難道是1美元？同樣，1英鎊價值1英鎊嗎？任何貨幣與自身價值比較都是沒有意義的，只有當它們被組合成對的時候才能顯現出價值。當妳面對壹個貨幣對的時候，妳看到的不僅僅是兩種貨幣還包括它們之間的比較。現在，妳可以用另壹種方式問剛才的問題，1美元值多少英鎊呢？或者說，1英鎊可以購買多少美元呢？",
            "將貨幣以成對的方式交易對新手來說是個難題，因為新手們已經習慣了買賣單壹的股票或者銷售單壹的共有基金這種模式，貨幣對這壹概念對他們而言還很陌生。所以，如果妳還不能接受貨幣對的概念，別擔心，還有許多人和妳壹樣。我們保證妳會逐漸熟悉。",
            "貨幣對",
            "在壹組貨幣對中，左邊的貨幣被稱為基準貨幣，右邊的貨幣被稱為計價貨幣。有壹個簡單的方法可以讓妳分辨兩者：基準貨幣的強弱決定了貨幣對的走勢，而計價貨幣的強弱則決定了貨幣對的價格。",
            "例如，最常見的貨幣對是歐元/美元，其中歐元是基準貨幣，美元是計價貨幣。歐元對比美元的強弱程度決定了貨幣對升值或貶值。如果歐元比美元強勢，那麽歐元/美元就會升值，反之則貶值。下面是壹個幫助妳理解貨幣對變化的口訣：",
            "基準貨幣強，計價貨幣弱，則貨幣對升值；",
            "基準貨幣弱，計價貨幣強，則貨幣對貶值；",
            "計價貨幣強，基準貨幣弱，則貨幣對貶值；",
            "計價貨幣弱，基準貨幣強，則貨幣對升值。",
            "要記住，壹個巴掌拍不響。基準貨幣和計價貨幣當中任何壹方的變化都會影響整個貨幣對的變化。",
            "歐元/美元的價格表示購買1歐元需要支付多少美元。比如，歐元/美元的價格是1.3055，它表示購買1歐元需要1.3055美元。與之類似，如果貨幣對價格漲到1.4277，那就表示購買1歐元需要1.4277美元。",
            "那麽，是誰決定把哪種貨幣作為基準貨幣，哪種貨幣作為計價貨幣的呢？答案很有趣壹是國際標準化組織(ISO)。作為壹個非政府組織，該組織致力於給混亂的世界帶來壹點秩序。",
            "貨幣對主要分為以下三種：",
            "主要貨幣對",
            "新興市場貨幣對",
            "交叉貨幣對",
            "主要貨幣對",
            "主要貨幣對是指由美元和世界其他六大貨幣所構成的貨幣對，包括：",
            "歐元/美元( EUR/USD)",
            "美元/日元( USD/JPY)",
            "英鎊/美元( GBP/USD)",
            "澳大利亞元/美元( AUD/USD)",
            ...
            "美元/加拿大元( USD/CAD)",
            "新興市場貨幣對",
            "新興市場貨幣對是指由美元和世界上其他主要貨幣構成的貨幣對。新興市場貨幣之所以得其名是由於其較差的流動性，例如，瑞典克朗(SEK)、新西蘭元(NZD)、南非蘭特(ZAR)等等。但是隨著新興市場貨幣越來越普及，它們的流動性也在逐漸被改善。",
            "接下來，讓我們看壹看新興市場貨幣對的列表，妳可從中選擇壹些進行投資以擴充個人投資組合：",
            "美元/港幣(USD/HKD)",
            "美元/瑞典克朗( USD/SEK)",
            "新西蘭元/美元( NZD/USD)",
            "美元/新加坡元(USD/SGD)",
            ...
            "美元/泰顳(USD/THB)",
            "交叉貨幣對",
            "交叉貨幣對表示基準貨幣和計價貨幣都不是美元的貨幣對。例如，歐元和英鎊，澳大利亞元和日元組成的貨幣對就是交叉貨幣對。 下面是壹些常見的交叉貨幣對",
            "英鎊/日元( GBP/JPY)",
            "歐元/英鎊( EUR/GBP)",
            "澳大利亞元/日元(AUD/JPY)",
            "歐元/瑞士法郎( EUR/CHF)",
            "加拿大元/日元( CAD/JPY)",
            "貨幣對以基點為單位變化",
            "常做股票、證券或者商品期貨交易的人習慣於用元和分作單位的報價。但是外匯市場卻不是這樣——貨幣對的價格單位是基點。",
            "什麽是基點？基點的英文PIP是\"Price Interest Point\"的簡稱，即“價格興趣點”。妳也可以稱它為“點”。在大多數情況下，壹個基點代表了壹個貨幣單位的萬分之壹。但是也有例外，比如，日元的壹個基點代表了1日元的百分之壹。壹直以來，基點是外匯市場中最小的交易價格點，可是近來外匯交易商卻開始使用更小的交易單位。最初，他們把“二分之壹基點”用在歐元/英鎊、歐元/瑞士法郎等貨幣對的交易上。後來隨著交易量的擴大，壹些交易商開始用“十分之壹基點”作單位，也就是小數點後五位數。",
            "基點價值",
            "那麽，壹個基點價值多少？這個問題問得非常好，答案壹般取決於幾個因素。",
            "在股票交易中，股票漲或跌了多少錢可以直接換算成妳賺或虧了多少錢。但是在計算每壹個基點(或在某些情況下，每十分之壹個基點)的價值時，妳必須知道基準貨幣是什麽，以及交易合約規模是多少才能計算。我們在第十二章講解外匯市場的投資工具時會對合約規模做進壹步說明，但是現在妳只須知道標準合約包含10萬個貨幣單位，而小合約包含1萬個貨幣單位。有個公式可以幫助妳計算出基點價值：",
            "(1個基點/匯率)X合約規模=基點價值",
            "讓我們代入真實數據，假設妳想知道壹份美元/日元標準合約中1個基點的價值，並且已知美元/日元匯率為82.65，妳可以代入公式計算出結果，表示如下：",
            "(0.01/82.65)×100000=12.10(美元)",
            "再舉壹例，假設妳想知道壹份歐元/美元小合約中1個基點的價值，並且已知匯率為1.3387，把數據代入公式，可得",
            "(0.0001/1.3387×10000=0.74699(歐元)",
            "當然，如果妳想知道美元在不是基準貨幣的情況下的1個基點價值多少，妳得在計算中多加壹個步驟。為了把1個非美元貨幣的基點價值轉換成美元的基點價值，妳需要用到以下公式：",
            "基點價值×匯率=美元的基點價值",
            "在剛才歐元/美元的例子中，美元的基點價值為：",
            "0.74699×1.3387=1(美元)",
            "有了這個公式，妳就能夠計算出任何貨幣的基點價值。",

        ],
    },
    wave: {
        name1: "外匯波動的背後推手——什麽在推動貨幣價格",
        name2: "",
        content: [
            "壹旦我們知道了是什麽東西創造出了自由貨幣市場，我們就能更好地理解今天是什麽影響著貨幣的價值；而且對現實知道的越多，我們就能為未來做好準備。例如外匯，只有明白了它背後的操作模式才能更好地去拿捏利潤的關鍵時刻。不浪費每壹次獲得財富的機會。",
            "壹、貿易流",
            "貿易流表示由兩國之間商品或服務的流通而產生的貨幣流，它壹般會受到兩種影響：",
            "外國對本國商品的需求",
            "本國對外國商品的需求",
            "外國對本國商品的需求",
            "外國對本國商品產生需求的同時，本國貨幣的需求量和外國貨幣的供應量通常也會相應增加。本國貨幣需求量的增加可使本國貨幣升值，而外國貨幣供應量的增加會使外國貨幣貶值。它的原理如下。",
            "假設壹位西班牙顧客想要購買美國制造的某件產品。作為消費者，這位西班牙人會很自然地想到用歐元支付，但是美國卻希望他用美元支付。為了讓這樁買賣成功，西班牙顧客必須先把歐元兌換成美元後再付錢。",
            "這壹兌換過程增加了市場上歐元的供應量，同時也助長了美元的需求量。這意味著歐元價值下降，美元價值上升。",
            "本國對外國商品的需求",
            "壹般來說，本國對外國商品產生需求的同時，外國貨幣的需求量和本國貨幣的供應量也相應增加。外國貨幣需求量的增加使外國貨幣升值，而本國貨幣供應量的增加使本國貨幣貶值。",
            "在剛才的例子中，如果我們把美國和西班牙的角色對調，就能得到壹個新例子，不過原理都相同。妳要記住，在國際貿易中，當貨幣從買方流向賣方時，買方貨幣貶值，賣方貨幣升值。",
            "二、投資流",
            "投資流表示兩國之間由壹國投資者在另壹國買賣資產而產生的貨幣流，它受三種因素影：",
            "外國對本國資產的需求",
            "本國對外國資產的需求",
            "資產遣返",
            "外國對本國資產的需求",
            "壹般條件下，外國對本國資產產生需求的同時，本國貨幣的需求量和外國貨幣的供應量也相應增加。本國貨幣需求量的增加使本國貨幣升值，而外國貨幣供應量的增加使外國貨幣貶值。它的原理如下。",
            "假設壹個日本投資者想購買新西蘭政府債券。作為投資者，日本人很自然地想到用日元支付，但是新西蘭政府卻希望他用新西蘭元支付。為了讓這樁買賣成功，日本投資者必須先把日元兌換成新西蘭元後，再把錢付給債券發行商。",
            "貨幣兌換增加了外匯市場中日元的供應量和對新西蘭元的需求量，從而導致日元升值，新西蘭元貶值。",
            "本國對外國資產的需求",
            "本國對外國資產產生需求的同時，本國貨幣的供應量和外國貨幣的需求量也相應增加。本國貨幣供應量的增加使本國貨幣貶值，而外國貨幣需求量的增加使外國貨幣升值。",
            "在剛才的例子中，如果我們把日本和新西蘭的角色對調，就能得到壹個新例子來說明這壹點。在國際資產交易中，當貨幣從買方流向賣方時，壹般來說，買方貨幣貶值，賣方貨幣升值。",
            "資產遣返",
            "資產遣返增加了本國貨幣的需求量和外國貨幣的供應量。本國貨幣需求量的增加使本國貨幣升值，而外國貨幣供應量的增加使外國貨幣貶值。",
            "三、貨幣供應量",
            "貨幣供應量是指壹個國家發行的貨幣總量。這個概念似乎很奇怪，但是在今天這個法定貨幣(指沒有任何實物資產作本位的貨幣)和計算機的時代，任何貨幣供應量的改變都可在瞬息間完成。政府的財政部門再也不必為了增加貨幣供應量而加印紙鈔壹壹盡管他們也可以這麽做。現在，他們只需在鏡盤上敲幾個鍵就能達到目的。",
            "壹個國家的貨幣供應量對外匯交易員來說很重要，因為它對貨幣價值有直接影響。貨幣發行量越大，貨幣價值越低;貨幣發行量越少，貨幣價值越高。",
            "壹國的貨幣供應量通常由以下部門或機構決定：",
            "政府財政部",
            "中央銀行",
            "財政部在決定貨幣發行量中所扮演的角色",
            "我們在之前提到過，財政部控制了造幣廠的貨幣印刷。鑒於法定貨幣沒有實物資產作為貨幣本位，財政部只需命令造幣廠準備好紙和墨並開動印刷機就能增加貨幣供應量。隨著這些新印紙幣的進入，貨幣供應量在真正意義上增加了。",
            "當然，如果這些紙幣是用來代替破舊和損害的貨幣，市場中流通的實物貨幣數量就不會變化。在這裏，妳只需記住壹點：開動壹下印鈔機的開關就能完成貨幣供應量的增加。",
            "中央銀行在決定貨幣發行量時所扮演的角色",
            "目前，開動印鈔機已經很容易了，但是中央銀行能更輕易地增加或減少貨幣的供應量——他們要做的事只是在電腦中輸入幾個數字，然後按下回車鍵。實際上，中央銀行每天都在印刷和銷毀貨幣。下面我們將以美國中央銀行—美國聯邦儲備局( Federal Reserve或Fed)為例說明。",
            "當美聯儲準備降息時，它會通過把短期抵押貸款(稱“回購協議”)貸給壹級交易商(大型銀行)的方式來增加貨幣供應量。根據回購協議，美聯儲從各個壹級交易商處借入美國國庫券，並將其從對方儲備賬戶中勾銷。協議期滿後，美聯儲將國庫券歸還給各個壹級交易商，並將記入對方儲備賬戶。",
            "當美聯儲準備加息時，它通過從壹級交易商(大型銀行)處購入短期抵押貸款(稱“回購協議”)的方式來減少貨幣供應量。根據回購協議，美聯儲將美國國庫券借給各個壹級交易商，並將其記入對方儲備賬戶。協議期滿後，美聯儲收購各個壹級交易商手中的國庫券，並將其從對方儲備賬戶中勾銷。",
            "四、政府幹預和貨幣操縱",
            "政府幹預和貨幣操縱指的是政府通過其中央銀行在外匯市場中采取的特定措施，使其貨幣價值上升或下降的行為。所謂的特定措施分為“直接幹預”和“口頭幹預”兩種。直接幹預是指政府通過在公開市場買賣貨幣的方式操縱貨幣價值。口頭幹預是指政府單純的口頭警告，實質上不幹預市場交易。在參與本國貨幣買賣時，政府理所當然地有很大的可能性去操縱貨幣。但是有時候僅靠警告就足以達到預期目標，政府根本無需投入大量資金。",
            "直接幹預和口頭幹預有兩種形式：協調幹預和單邊幹預。協調幹預是指多國政府以直接幹預或口頭幹預的形式進行市場幹預。單邊幹預是指壹國政府單獨參與貨幣操縱。",
            "從長遠看，協調幹預比口頭幹預更為有效。但我們可以肯定的是，單邊幹預在短期內能對市場產生巨大影響，只是效果不長久。 那麽，政府為什麽要幹預市場？這是因為：",
            "擔心貨幣走勢過強",
            "擔心貨幣走勢過弱",
            "將本國貨幣釘住另壹國貨幣",
            "擔心貨幣走勢過強",
            "為什麽政府要擔心貨幣走勢過強？難道貨幣強勢並不表示經濟運行良，貨幣需求量大嗎？政府似乎並不擔心自己的貨幣走勢強勁，除非出口受到影響。如果壹個國家無法出口其產品和服務，那麽就業崗位就會減少，公眾會開始責怪政府，無奈之下，政府決定采取措施，這樣壹來，政客們也就能保住飯碗了。",
            "擔心貨幣走勢過弱",
            "為什麽政府要擔心貨幣走勢過弱？難道貨幣疲軟並不代表國家更容易出口產品和服務嗎？",
            "的確是這樣，但是貨幣貶值過多還是會引起政府的擔憂，即使是那些擁有強勢貨幣的政府也會擔心其他貨幣的過度貶值會讓全球經濟雪上加霜。",
            "將本國貨幣釘住另壹國貨幣",
            "壹些國家和地區的政府——如中國、沙特阿拉伯、丹麥等——為了保持自身在全球金融市場中的穩定性，會將其貨幣釘住另壹國貨幣，比如美元或歐元。",
            "將壹種貨幣釘住另壹種貨幣需要對外匯市場持續幹預和操控。無論何時，只要被掛鉤貨幣的需求量上升，政府就要采取賣出和（或）多發行掛鉤貨幣的方式來增加其供應量，以穩定價格。",
            "五、投資者恐慌",
            "在外匯市場做交易時，妳需要記住有壹件很重要的事：外匯市場由許多像妳這樣的人組成。推動市場前進的最根本因素是人，所以人的情緒(尤其是恐慌)永遠與市場同在。",
            "在今天的貨幣市場中，投資者恐慌是最大的影響因素之壹。實際上，投資者恐慌太重要了，以至於它的出現會讓影響市場的其他重要因素黯然失色。當經濟危機發生時，它既可以讓某些貨幣暴跌，也可以讓某些貨幣飛漲。想要好好利用這壹市場動態，妳得先知道哪些貨幣可以在經濟蕭條時逆市繁榮。",
            "避險貨幣",
            "避險貨幣可以在投資者恐慌肆虐時繁榮。“避險貨幣”之所以得名是因為它們能在金融動蕩時提供庇護。避險貨幣包括美元(USD)、瑞士法郎(CHF)和日元(JPY)。",
            "它們成為避險貨幣的原因各不相同。",
            "美元之所以成為避險貨幣是因為美國國債的安全性，它能在全球經濟危機時吸引大量投資者。美國國債需求量的增加促使美元需求量也增加，從而使美元升值。畢竟，誰不希望自己手中的避險貨幣能在形勢蕭條時升值呢？",
            "瑞土法郎之所以會成為避險貨幣是因為市場上的大部分瑞士法郎都由黃金支持。雖然這個比例較從前有所下降，但相比其法定貨幣，瑞士法郎仍擁有相當穩定的黃金支持。同時，瑞土經濟被認為是非常穩定的，它的通脹率通常很低。",
            "日元之所以會成為避險貨幣源於日本政府債券市場的穩定。不同於美國國債大部分由海外政府和投資者持有，絕大部分日本國債由本國私人投資者持有。這給日本經濟增加了穩定性，同時也減少了日本政府為擺脫債務而實行通貨膨脹政策的可能性——某些國家在債務負擔過重時會這麽做。通脹風險小的貨幣會更安全。",
            "測量投資者恐慌",
            "投資者的恐慌和信心非常抽象，由於缺乏統計的量化方法，人們很難去測量和分析它。然而，妳可以根據壹組數據來測量投資者恐慌，那就是芝加哥期權交易所波動率指數( CBOE VIX)。",
            "該指數基於標準普爾500指數期權的波動水平。",
            "該指數升高表示投資者恐慌增加。",
            "該指數降低表示投資者恐慌減少",
        ],
    },
    realize: {
        name1: "看清外匯市場——外匯交易員關註的指標",
        name2: "",
        content: [
            "波動率指數：芝加哥期權交易所的波動率指數",
            "芝加哥期權交易所的波動率指數（VIX）對於投資大眾而言是最好的風險和情緒評估指數之壹；外匯市場上的所有交易員幾乎都能有效運用這壹指數。VIX俗稱“恐懼指數”，但實際上這壹稱呼會讓人產生壹些誤解，因為VIX並不直接衡量任何類型的恐懼。VIX的衡量其實是交易員對於標準普爾500指數的波動率的預期。這壹預期會以指數的形式標繪出來，指數越高，交易員對於短期市場波動率的預期越高。",
            "市場波動率越高，VIX就越高，因為VIX衡量的是標準普爾500指數期權虛值期權的價格。如果期權的賣方認為波動率在不久之後會上升，他們會向期權的買方要求更高的期權費。這壹期權價格的上漲被用於VIX指數的計算中。相反，如果期權的賣方認為波動率將會下降，那麽他們會降低期權費來吸引買方。期權價格下跌，則VIX指數通常也呈下降趨勢。",
            "在每個交易日，VIX都會實時關註投資者情感和期權費的變化。VIX讀數是壹個按年度比率重估的數字，反映了交易員認為在未來30天內標準普爾500指數的漲跌幅。如果VIX讀數是30，或者30%，這表明交易員認為在接下來的壹個月內，標準普爾500指數可能有2.5%的漲跌幅(30%÷12個月=2.5%)。",
            "正如VIX所示，交易員的預期是毫無方向的。在上壹例中，我們可以認為交易員預期標準普爾500指數在某個方向上會有2.5%的漲跌幅，但並沒有具體指明是漲還是跌。然而，意外的市場波動具有下行傾向，所以上升的VIX指數通常意味著看跌預期。記住，市場不會暴漲，只會暴跌。",
            "所以，如果交易員預期顯著的波動率，那麽這通常就是壹個看跌的跡象。這也就是為什麽VIX通常被稱為恐懼指數了。如果投資者擔心波動率上升，那麽VIX指數會上升;相反，如果投資者預期波動率較低，那麽VIX指數會下降，這也被認為是壹個看漲跡象。壹般情況都遵循這個規律，但如果我們每天觀察就會發現，還是有例外情況的。",
            "這個含義很明顯。如果VIX呈下降趨勢，投資者的交易采取看漲時的策略，願意承擔更多風險。如果VIX呈上升趨勢，交易員可能會做空市場，試圖限制其投資組合的風險。VIX通常都是處於某壹範圍內的，所以當VIX指數到達支撐位或阻力位時，操盤手會變得特別有興致。",
            "根據VIX指數，看跌或看漲時交易員的感覺是非常重要的，因為這可以表明他們對於風險的態度。最終，投資者恐懼的增加與股票下跌、債券上漲和美元走強有關。反之亦然。",
            "當市場風險可能增加或減少時，VIX指數可以被用來分析、判断入市和出市的時機或時期。這個信息非常有用，因為這不僅僅是對於價格-時間研究的重復，而且是源自投資者對於近期波動率的預期。那麽，當妳分析VIX指數時，妳應該關註什麽呢？妳應該關註：",
            "當VIX指數開始呈上升趨勢時，避險貨幣會升值；",
            "當VIX指數開始呈下降趨勢時，高風險、高收益的貨幣會升值。",
            "10年期債券收益率息差",
            "密切註意10年期債券收益率息差可以讓妳清楚了解未來的投資流向。不過妳不能只尋找收益最高的國家，預期該國貨幣會不断繼續升值。妳應該尋找債券收益率不断增加的國家。債券收益率的變動可以改變投資流向，這可以引起貨幣升值。",
            "例如，如果妳在關註瑞士的債券收益率，妳發現它們穩步走高，這或許是瑞士法郎可能升值的壹個可靠信號。如果妳同時也發現美國的債券收益率開始下降，那麽妳應該認真考慮進行壹個交易，好好利用瑞士法郎的走強和美元的走弱。",
            "股票市場表現",
            "密切註意股票市場的表現也可以讓妳清楚了解未來的投資流向。不過和債券收益率壹樣，妳不能只尋找股市最強勁的國家，並預期該國貨幣會不断升值。妳應該尋找股市越來越強勁的國家。股市實力的變化可以改變投資流向，這可以引起貨幣升值。",
            "比如，如果妳在關註日本的股票市場表現，妳發現日本股市開始穩步走高，這或許就是日元可能升值的壹個可靠信號。如果妳同時也發現英國的股市開始下降，那麽妳應該認真考慮進行壹個交易，好好利用日元的走強和英鎊的走弱。",
            "美國聯邦基金期貨價格",
            "交易員可以根據美國聯邦基金期貨價格和他們對於美國聯邦基金利率變動的預期買賣期貨。當交易員認為美聯儲會在未來提高利率時，他們壹般會賣出這些期貨合約；當交易員認為美聯儲會在未來降低利率時，他們則會買入這些期貨合約。這些合約是機構交易員對沖利率風險、推測未來變化的壹個非常好的方式。",
            "對於那些想要了解長期市場預期的外匯交易員而言，美國聯邦基金期貨價格利率是非常有用的。如果美國聯邦基金期貨價格利率低於目前的利率，這表明交易員有壹個利率降低的預期，通常對於美元而言是個壞消息。相反，如果美國聯邦基金期貨價格利率高於目前的利率，這表明交易員有壹個利率開高的預期，這對於美元而言通常是個好消息。",
            "如果妳習慣交易其他期貨合約，那麽妳可能壹開始會覺得美國聯邦基金期貨的定價方式有點難懂。價格利率的計算方式是100%減去預期聯邦基金利率。例如，如果當前的價格利率是96%，那麽妳就能知道交易員預期聯邦基金利率是4%(即100%-96%=4%)與此類似，如果聯邦基金期貨價格利率從96%升至98%，那麽這壹般表明交易員認為聯邦基金利率將從4%降至2%。這種漲幅變化當然是在長期發生的，而且是在很長壹段時間內，聯邦基金期貨價格利率的變動可以在壹個非常小的範圍內。",
            "美國聯邦基金期貨價格利率圖表明交易員對於未來利率變化的預期，而不是關於目前的利率，記住這點是很重要的。美國聯邦基金期貨價格利率圖是分析師和交易員經常用作參考的，而且也是能夠幫助妳了解利率可能走向的非常好的來源。妳可以在芝加哥商品交易所的網站上找到聯邦基金期貨價格利率圖。妳還可以在克利夫蘭聯儲的網站上看到很多關於聯邦基金期貨期權的預測能力的討論。",
            "那麽，當妳分析美國聯邦基金期貨價格利率時，妳應該關註什麽呢？妳應該關註：",
            "當利率開始上升時，美元貶值;",
            "當利率開始下降時，美元升值。",
            "持倉報告（COT）",
            "操盤手幾乎每周都可以得到特殊的市場報告，這IE報告簡要介紹了大型機構交易員金額小型投資者所持各種商品期貨品種（包括外匯）的倉位。這個信息叫做持倉報告，或COT報告，是由商品期貨交易委員會(CFTC)提供的。",
            "持倉報告對於任何市場的交易員而言都是非常好的分析工具，因為該報告提供了關於每個商品市場的走向和交易員對該走向的承諾力度的最新信息持倉報告主要說明了三類不同的交易員所持的現有期貨合約的凈多頭和空頭的倉位情況：商業交易員、非商業交易員和未報告交易員。如果交易員做多頭，或在增加他們的多頭頭寸，那麽他們壹般是對市場看好;類似，如果他們做空頭，或在增加他們的空頭頭寸，那麽他們對市場看跌。",
            "報告中並非所有的交易員都壹樣重要。實際上，在這三類交易員中，投資者通常應關註與其他個人交易員有同樣需求的壹類交易者——非商業交易員。",
            "商業交易員：這類交易員代表了那些用期貨市場來抵消現金或現貨市場風險的公司和機構。例如，如果美元會在近期貶值的話，壹家有美國公司的應收賬款的日本汽車制造廠可能就會出售美元期貨合約來保護自身利潤。對於零售交易員而言，這類交易員並沒有什麽可參考性，所以我們不會過多關註。",
            "非商業交易員：這類交易員包括大型機構投資者、對沖基金和其他為了投資和增長在期貨市場進行交易的實體。他們通常不直接參與生產、銷售或基本商品或資產的管理。我們應主要關註這類交易員。",
            "未報告交易員：這類包含甚廣，主要是那些小交易員，他們所持倉位非常小，不需要報告給商品期貨交易委員會。我們不知道這類包含了多少個交易員或者他們代表了哪種類型的投資者，因為他們是未被報告的。大多數市場專家認為這類交易員的主要群體是個人投機者。他們是出名的臭手，妳經常可以發現，這類交易員通常都是與市場趨勢對著幹的，而不是順著來的。我們不關註這類交易員。",
            "那麽，當妳分析持倉報告時，妳應該關註什麽呢？妳應該關註：",
            "當凈多頭倉位增加或凈空頭倉位減少時，報告中提到的貨幣會升值",
            "當凈多頭倉位減少或凈空頭倉位增加時，報告中提到的貨幣會貶值",
        ],
    },
    main: {
        name: "主要貨幣對的概況和特性",
        content: [
            "壹、貨幣簡介：美元(USD)",
            "美國是世界的主要經濟動力，其2006年的國內生產總值超過了11萬億美元。這是世界上最大的GDP數值，根據購買力平價模型，這個數值是日本產值的3倍，德國的5倍，英國的7倍。美國是以服務業為主導產業的國家，幾乎80%的GDP都來自房地產、交通、金融、醫療保健和商業服務行業。然而，美國規模龐大的制造業仍然使得美元對制造業的發展狀況極為敏感。美國擁有世界上最具流動性的股票市場和固定收益市場，外國投資者壹直都在增加美國資產的購買。根據國際貨幣基金組織統計，外國對美國的直接投資幾乎達到美國的全球凈流入總額的40%。",
            "特性：",
            "1、超過90%的外匯交易都涉及到美元",
            "2、在9.11事件之前，美元被認為是世界首要的避險貨幣之壹",
            "3、美元的走勢與黃金的走勢相反",
            "4、很多新興市場的貨幣都釘住美元",
            "5、密切關註美國國庫券和外國債券的利率差異",
            "6、留意美元指數",
            "7、美元的交易受到股票和債券市場的影響",
            "二、貨幣簡介：歐元(EUR)",
            "歐洲貨幣聯盟是世界第二大經濟體，2006年的國內生產總值約為12萬億美元。歐洲貨幣聯盟有高度發達的固定收益市場、股票市場和期貨市場，所以對國內外投資者來說，也是世界第二個最具吸引力的投資市場。",
            "特性：",
            "1、歐元/美元是最具流動性的貨幣對，所有主要的歐元交叉貨幣對也非常具有流動性",
            "2、歐元具有獨壹無二的風險",
            "3、10年期美國國庫券和10年期德國國債的價差可以指示市場對歐元的情緒",
            "4、預測歐元區的資金流動",
            "三、貨幣簡介：英鎊(GBP)",
            "英國是世界第四大經濟體，由於有壹個世界效率最高之壹的央行，英國經歷了多年的強勁經濟增長、低失業率、產能擴張和富有彈性的消費。消費者的消費力度大部分源於英國強勁的房地產市場，該市場在2003年達到頂點。英國是壹個以服務業為主導產業的經濟體，制造業在GDP中的比重逐漸減小，現在只相當於國內產值的1/5。英國的資本市場是世界最發達的市場之壹，因而金融和銀行業對英國的GDP貢獻最大。",
            "特性：",
            "1、英鎊/美元非常具有流動性",
            "2、英鎊有三個名字：the British Pound、Sterling、Cable",
            "3、英鎊有大量投機者參與其中",
            "4、密切關註應該金邊債券和外國債券的利率差異",
            "5、歐洲英鎊期貨（Eurosterling futures）可以為利率變動提供指示",
            "6、英國政客對歐元的評論會影響歐元走勢",
            "7、英鎊與能源價格具有正相關性",
            "8、英鎊有關的交叉貨幣對",
            "四、瑞士法郎(CHF)",
            "瑞士是世界第19大經濟體，2006年的GDP超過了2550億美元。這經濟體雖然相對較小，但如果按人均GDP計算，卻是世界最富有的壹個。它的繁榮程度和先進的技術比得上很多更大的經濟體。國家繁榮主要因為制造業、旅遊業和銀行業具有相當的專業性，具體地說，瑞士的化學和制藥業、機器、精密儀器、手表非常著名，尤其是金融系統在保護投資者機密方面在歷史上就已聞名於世。加上瑞士長久以來的政治中立，為國家和貨幣創造了安全避所的美譽。",
            "特性：",
            "1、安全避難所的地位",
            "2、瑞郎與黃金的關系密切",
            "3、套息交易效應",
            "4、密切關註歐洲瑞郎期貨和外國利率期貨間的利息差異",
            "5、銀行制度有可能發生改變",
            "6、跨國並購活動",
            "7、瑞郎相關交易行為和交叉貨幣對的特征",
            "五、日元(JPY)",
            "日本是世界第三大經濟體，2006年的GDP超過了4.2萬億(僅次於美國和整個歐元區或歐洲貨幣聯盟)，也是世界第二大主權經濟體。日本還是世界最大的出口國之壹，每年出口額超過5000億美元。",
            "特性：",
            "1、亞洲貨幣整體強/弱代表",
            "2、日本央行的幹預習慣",
            "3、日元的波動季節性很強",
            ...
            "5、套息交易效應",
            "六、澳元(AUD)",
            "就GDP而言，澳大利亞是亞太地區第五大國家。在2006年，它的GDP約為6740億美元。雖然這個經濟體相對較小，但如果按人均GDP計算，它可以比上西歐很多工業國家。澳大利亞以服務業為主導產業接近79%的GDP來自金融、房地產和商業服務等行業。",
            "特性：",
            "1、商品貨幣",
            "2、套息交易效應",
            "3、幹旱效應",
            "七、新西蘭元(NZD)",
            "新西蘭是個很小的經濟體，2006年的GDP約為1070億美元。它曾經是經濟合作與發展組織裏管制最嚴的國家，但在過去20年，新西蘭逐漸朝著壹個更開放、更現代和更穩定的經濟體邁進。",
            "特性：",
            "1、與澳元有非常強的相關性",
            "2、商品貨幣",
            "3、套息交易",
            ...
            "6、幹旱效應",
            "八、加拿大元(CAD)",
            "加拿大是世界第七大國家，2006年的GDP達到11780億美元。從1991年開始，加拿大的經濟就穩步增長。由於加拿大早期的經濟發展完全依賴國家自然資源的開采和出口，所以通常被認為是資源性經濟體。現在，它是世界第五大黃金生產國和第四大石油出產國。",
            "特性：",
            "1、商品貨幣",
            "2、與美國有非常緊密的關系",
            "3、並購",
    ...
    go: {
        name: "走進貨幣——12個關鍵問題",
        content: [
            "貨幣和人壹樣具有性格。有些貨幣個性抑郁，有些貨幣活潑好動，也有壹些貨幣死氣沈沈。正是如此，外匯市場才會那麽有趣。",
            "當妳在外匯市場中交易貨幣時，妳要和不同的貨幣建立關系，所以妳最好了解它們。在了解的過程中，妳會發現有壹些貨幣和妳意氣相投，也有壹些與妳格格不入。",
            "為了讓妳更好地了解貨幣，我們為妳提供“速配約會”服務。我們預感到妳會害羞和尷尬，所以在妳赴約前，我們替妳準備了12個需要回答的問題。",
            "這些問題有何特別之處？妳為什麽要花時間學習這些東西？",
            "首先，妳對貨幣越了解，妳就能輕松地做出投資選擇——這是常識。更重要的是，妳要盡可能謹慎地投資貨幣，避免被突如其來的變故害的傾家蕩產。現在讓我們壹起來看看這12個問題，看看它們為什麽和妳的投資決定相關聯。",
            "壹、妳們的經濟處於貿易順差還是貿易逆差",
            "貿易順差國的貨幣往往較為強勢，原因是貿易順差國的產品服務需求量更大，而國外買家購買時必須用賣方貨幣支付，從而導致其貨幣需求量增加。相反，貿易逆差國的貨幣往往較為疲軟，原因是買方國家在支付所購買產品和服務時需要將本國貨幣兌換成賣方國家的貨幣，如此壹來，本國貨幣的供應量上升，其價值減少。",
            "二、妳們出口什麽",
            "我們為什麽要關心壹個國家出口什麽產品和服務？這是因為如果知道壹個國家出口的主要產品和服務，我們就能清楚什麽樣的市場和價格需要關註，而這些市場和價格的變化也正是該國貨幣變化的預兆。",
            "例如，新西蘭是世界主要的奶制品出口國，出口產品包括黃油、奶酪、牛奶和奶粉。知道這壹點，妳就應該清楚自己需要關註的是奶制品價格。如果奶制品價格上漲，購買相同數量的奶制品，進口商就不得不兌換更多的新西蘭元。因此，本國貨幣會由於市場供應量增加而貶值，新西蘭元由於需求量增加而升值。反之，如果奶制品價格下跌，購買相同數量的奶制品，進口商就要減少新西蘭元的兌換量。這很可能會導致本國貨幣因供應量緩慢下降而升值：新西蘭元因市場需求量減小而貶值。",
            "妳會發現，這種分析方法特別適用於評估那些實行商品經濟的國家的貨幣，例如，澳大利亞、新西蘭、加拿大等國家。",
            "隨著學習的深入，在對壹個國家出口的產品和服務進行分類時，我們將用到世界貿易組織（WTO）使用的壹套分類法，該組織把產品和服務分為如下幾類：",
            "商品貿易：農產品、燃料和礦產品、制造品",
            "商業服務貿易：運輸、旅遊、其他商業服務",
            "三、妳們向誰出口",
            "我們為什麽要關心壹個國家向誰出口產品和服務？因為通過調查從外部進口某種產品的國家的經濟健康程度，妳可以預測出未來這些國家對該產品的需求量。",
            "例如，澳大利亞出口到中國的產品比出口到其他任何國家的都多。或者換壹種說法，中國從澳大利亞進口的產品比其他任何國家從澳大利亞進口的產品都多。無論用哪種方式表達，妳都能看出中國是澳大利亞極其重要的貿易夥伴。",
            "知道了這壹點，妳就可以開始調查中國的GDP、就業率、生產數據等指數然後推測出中國在未來是否仍是澳大利亞最大的進口國。如果中國的經濟指標很強，那麽澳大利亞對中國的出口仍將保持旺盛的活力，同時澳大利亞元的需求量和價值都能保持較高水平;如果中國的經濟指標不夠強，那麽澳大利亞對中國的出口將呈下降趨勢，同時澳大利亞元的需求量和價值也會降低。",
            "四、妳們進口什麽",
            "我們為什麽要關心壹個國家進口什麽產品和服務？因為如果我們知道了壹個國家進口的主要產品和服務，我們就能清楚什麽樣的市場和價格需要關註，而這些市場和價格的變化也正是該國貨幣變化的預兆。",
            "比如，日本是壹個石油凈進口國，實際上它目前是全球第四大石油進口國。由於日本嚴重依賴石油進口，而石油價格又以美元為單位，所以日元對石油價格的變動很敏感。當石油價格上漲時，為了購買相同數量的石油，日本不得不增加日元對美元的兌換量，從而導致日元價值因市場供應量增加而下降，美元價值由於需求量增加而上升。反之，如果石油價格下跌，為了購買相應數量的石油，日本不得不減少日元對美元的兌換量。這可能會造成日元因市場供應量緩慢增加而升值，美元因市場需求量減少而貶值。隨著學習的深入，在對壹個國家進口的產品和服務分類的時候，我們將使用討論出口時所用到的WTO分類法。",
            "五、妳們的進口來自哪裏",
            "我們為什麽要關心壹個國家從誰那裏進口產品和服務?因為出口國的貨幣價值通常會直接影響進口國的貨幣價值。",
            "舉個例子，加拿大超過半數的進口產品和服務來自美國。也就是說，加拿大的貨幣和經濟極易受到美元的影響。如果美元升值，為了購買相同數量的產品和服務，加拿大必須增加美元的兌換量。這會導致加拿大元因市場供應量增加而貶值，美元因市場需求量增加而升值。反之，如果美元貶值，為了購買相同數量的產品和服務，加拿大要減少美元的兌換量，從而使加拿大元因市場供應量緩慢下降而升值，美元因市場需求減少而貶值。",
            "六、妳們的國債市場是否具有吸引力",
            "我們為什麽要關心壹個國家的國債市場是否具有吸引力?因為倘若壹國的國債市場具有吸引力，那麽它通常能吸引大量的海外投資。壹般情況下，當投資增加時，貨幣會因其需求量增加而升值。",
            "當投資增加時，貨幣會因其需求量增加而升值投資者在評估壹個國家的國債市場時壹般要考量兩個問題：",
            "1、市場風險有多大?",
            "2、我的投資回報預期是什麽?",
            "這兩個問題雖然至關重要，但是兩者決不能單獨來看。例如，某國債務市場風險巨大，政府有可能無法償還債務，所以不適合投資者投資。但同時該國的投資回報率卻相當高，對投資者來說具有很大的吸引力。反過來說，某國債務市場風險很小，適合投資：但同時投資回報率不高，投資者也有理由不投資。所以，投資者在投資前需要權衡兩者。",
            "理想化的情況是，投資者尋求違約風險低但投資回報率高的國家進行投資。但是請妳問問自己，有幾個國家擁有低風險、高回報的市場?如果妳在均衡風險和回報的話，難道不應該風險大的市場回報高，風險小的市場回報低嗎?對於這個問題，答案沒有絕對的“是”與“不是”。",
            "壹個國家的國債市場必然受到市場風險的影響，但是這並不是唯壹的影響因素。無論是刺激經濟還是降低通貨膨脹，中央銀行的措施在很大程度上決定了國債市場的回報率。例如，澳大利亞國債市場被認為是相對安全的，但隨著本國經濟的繁榮(很大程度是因為向中國出口原材料)，其中央銀行壹澳大利亞儲備銀行( Reserve Bank of Australia)上調了利率以防止惡性通貨膨脹。這壹舉措加大了投資者在澳大利亞國債市場上的回報。",
            "所以，在比較各國國債市場的時候，我們要挑出利率高、市場穩定的國家。",
            "投資者在評估壹個國家國債市場的風險等級時可以參考兩個數據：穆迪長期債務評級和債務率(債務占國內生產總值的比重)。",
            "穆迪長債務評級",
            "穆迪長期債務評級是有關金融債務(原始到期日為壹年及以上)相對信用風險的意見，它壹般會揭示出金融債務無法按承諾履行的可能性，同時反映了違約發生的幾率以及違約後造成的壹切經濟損失，評級過程使用穆迪公司的全球化評級方法，它將債務分成如下九個等級",
            "1、Aaa級：債務質量最高，信用風險最低",
            "2、Aa級：債務質量很高，信用風險很低",
            "3、A級：債務質量中上等，信用風險低",
            "4、Ba級：債務質量中等，信用風險壹般並帶有不確定性",
            "5、Ba級：債務具有投機性，信用風險較高",
            "6、B級：債務具有投機性，信用風險高",
            "7、Caa級：債務質量差，信用風險很高",
            "8、Ca級：債務投機性高，違約可能性很大，但違約後存在本金利息追回的可能性",
            "9、C級：債務質量最低，通常情況下會違約，違約後本金利息追回的能性極小",
            "另外，穆迪公司還在每種等級分類(從Aa到Caa)前標上數字1、2、3。其中，數字1表示債務在所屬類別中排名靠前，數字2表示債務在所屬類別中排名居中，數字3則表示債務在所屬類別中排名靠後。",
            "債務與GDP的比率通常衡量了壹個國家的負債程度。如果某人年收入50000美元，每年負債60000美元去支付壹棟房、兩輛車、壹艘船和五張信用卡的債務，這對大部分金融機構來說，都具有較高的信用風險。同樣，大部分金融機構也會認為壹個負債率高的國家有較高的信用風險。",
            "壹般來說，負債率高的國家會用提高利率的方法吸引他國的借貸。這種做法能夠長期幫助投資者的風險回報比率達到平衡，但又打破了壹個國家能同時擁有低風險和高回報的美好願景。",
            "七、妳們的股票市場是否具有吸引力",
            "我們為什麽要關心壹個國家的股票市場是否具有吸引力?因為倘若壹國的股票市場具有吸引力，那麽它通常能吸引大量的海外投資。壹般情況下，當投資增加時，貨幣會因其需求量增加而升值。",
            "投資者在評估壹個國家的股票市場時要考量兩個問題",
            "1、市場風險有多大?",
            "2、我的投資回報預期是什麽?",
            "股票市場的風險壹般受多種因素的影響。市場規模至關重要。相比小而不成熟的股票市場，大而成熟的股票市場(如美國)具有更安全的投資環境。大型股票市場壹般都擁有大量投資者，以及供投資者選擇的不同股票類型，同時它還具備很強的流動性。",
            "大型股票市場的監管更為有效。比如，想在紐約證券交易所(NYSE)上市的公司會比在博茨瓦納證券交易所(BSE)上市的公司面臨更加煩瑣的申報要求。但是，公司提供的信息越準確，投資者越有信心投入更多的錢購買其股票。",
            "投資者自然會權衡股票市場的風險和投資後的潛在利潤。高回報的股票市場通常具有高風險;反之，對於回報低的股票市場，其投資風險可能也不高。",
            "理想化的情況是，投資者尋求到回報高且穩定的股票市場進行投資。",
            "八、央行的職責以及持有的黃金和外匯儲備",
            "我們為什麽要關心壹個國家的中央銀行是什麽、職責是什麽以及其黃金和外匯儲備量是多少？因為比起壹個國家的其他機構，中央銀行往往更能決定其貨幣走向強勢還是弱勢。",
            "所幸的是，中央銀行並沒有隨意加入外匯市場去操控貨幣的高低，它在市場中走的每壹步都遵循自己的職責。壹些中央銀行被授予控制經濟增長的職責，放置經濟擴張或收縮過快；另壹些中央銀行則被授予放置失業率過高的職責；還有壹些中央銀行的職責包含前兩者（有時會很復雜）。理解監管管妳所交易的貨幣的中央銀行的職責，大多能幫助妳預測在不同市場形勢下銀行可能采取的措施。",
            "除了職責之外，妳還需要知道中央銀行持有多少黃金和外匯儲備。我們從中央銀行的黃金和外匯儲備量中可以看出它幹預自由市場的能力。儲備量小的中央銀行壹般沒有足夠的資本去幹預動蕩的外匯市場和劇烈的價格波動：相反，儲備量大的中央銀行在外匯市場中遊刃有余，甚至在必要的時候可以調整市場。",
            "在了解中央銀行的過程中，妳要關註任何表明中央銀行在改變其外匯構成的消息。我們發現，各個中央銀行的去美元化正在慢慢形成壹種趨勢。如果這種趨勢在未來繼續發展，那麽美元的總需求量將會受到影響。",
            "九、政府是否過多幹預外匯市場",
            "我們為什麽要關心貨幣發行時政府是否過多幹預外匯市場呢？因為政府在外匯市場的活躍程度影響著我們交易貨幣的方式。",
            "有些政府時刻進行著市場幹預，這是因為他們在努力保持本國貨幣與別種貨幣或壹攬子貨幣掛鉤。還有壹些政府從不幹預市場，他們認為市場應該沿自己的軌跡運行，任何形式的幹預都可能產生某些不良影響。",
            "然而在大多數情況下，妳會發現政府有必要在某些時候插手市場進行幹預，盡管這樣的時候不多。",
            "十、哪些經濟數據是重要的",
            "我們為什麽要關心哪些經濟數據是重要的？因為如果我們知道什麽樣的經濟數據是重要的，我們就能夠及時觀察這些經濟數據，因為其趨勢做準備。",
            "十壹、貨幣是避險貨幣嗎",
            "我們為什麽要關心壹個國家的貨幣是否是避險幣？這是因為貨幣規避風險的能力會影響經濟危機時期貨幣的交易方式。比如，瑞士法郎是避險貨幣，所以當投資者恐慌增加時，其價值通常也會增加。再比如，新西蘭元不是避險貨幣，所以當投資者恐慌增加時，其價值壹般會下降。",
            "十二、我如何交易妳們的貨幣",
            "我們為什麽要關心壹種貨幣的投資工具是什麽？因為我們花大量時間、精力學習外匯市場知識和影響每種貨幣的因素，大多只為壹個目的：在外匯市場中賺錢。無論是期貨合同、現貨合同，還是交易所交易基金，知道自己能以何種方式投資均可以幫助我們決定把錢投入到哪裏賺錢。",
            "下面我們將通過介紹壹些投資工具來告訴妳如何交易貨幣：",
            "1、現貨外匯；",
            "2、外匯期貨；",
            "3、交易所交易基金（ETF）；",
            "4、交易所交易票據（ETN）；",
