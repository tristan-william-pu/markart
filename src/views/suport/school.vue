  ...
  <div>
    ...
    <!--A-Z-->
		<div class="az">
          ...
          <li v-for="(list,index) in words" :key="index">
		...
		<div class="teaBg">
			<div class="center clearfix">
				<div class="fl">
					...
					<p class="bot">TALK <span>策略</span></p>
				</div>
				<div class="fr">
					<p class="fl">首席分析师</p>
...
@media screen and (min-width:768px){
	...
	.video .center>.vidCon>div.fl,.video .center>.vidCon>ul li{
		overflow: hidden;
	}
	.video .center>.vidCon>div.fl>a>img,.video .center>.vidCon>ul li img{
		width: 100%;
		cursor: pointer;
		transition: all 0.6s;
	}
	.video .center>.vidCon>div.fl:hover>a>img,.video .center>.vidCon>ul li:hover img{
	...
	.know .center>ul.list li.three p.cen,.know .center>ul.list li.four p.cen{
	...
	@media screen and (max-width:1200px){
    	...
    	.teaBg {
		    background: url(../../../public/images/sch/teacher.png) no-repeat center top;
