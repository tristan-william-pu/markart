const contents = [
    ...
    zhlong:["Accrual：累積，在每壹次交易期間內，遠期外匯交易所分配的升水或折扣直接關系至利益套匯交易。",
        "Account balance/account value：賬戶余額/賬戶價值在計算所有的進項和貸項後，某個賬戶在某個時間所持的凈額。",
        "Adjustment：調整，官方行動，用於調整內部經濟政策來修正國際收支或貨幣。",
        "AIM (Alternative Investment Market) : （另類投資市場）倫敦證券交易所 (LSE) 的子市場，小型企業在此籌資所適用的監管制度相較於倫敦證券交易所的主市場更為靈活。不提供另類投資市場上市股票的差價合約產品。",
        "Appreciation：增值,當物價應市場需求擡升時,壹種貨幣即被稱作增值，資產價值因而增加。",
        "Arbitrage：套匯，利用不同市場的對沖價格,通過買入或賣出信用工具,同時在相應市場中買入相同金額但方向相反的頭寸，以便從細微價格差額中獲利。",
        "Ask(Offer) Price：賣出(買入)價，在壹外匯交易合同或交叉貨幣交易合同中壹指定貨幣的賣出價格。以此價格，交易者可以買進基礎貨幣。在報價中,它通常為報價的右部價格。",
        "At Best：最佳價格，壹指示告訴交易者最好的買進/賣出價格。現價或更好，壹交易以壹特定或更理想匯率執行。",
        "AUD-Australian DollAr：澳元",
    ],
    enlong:[
    ...
    zhlong:[
        "Backwardation：現貨溢價。該理論指由於期貨合約期限將至，將以高於到期後價格的價格進行交易。亦請參閱“期貨溢價",
        "Balance of trade：國際收支，指壹國承認的,在壹定時期內對外交易的記錄包括商品、服務和資本流動。",
        "Bar Chart：棒形圖表,壹種由4個突點組成的圖表:最高和最低價格組成垂直棒狀，被壹小水平線標誌於棒形的左端為開市價格,右端的小水平線則為關市價格。",
        "Base Currency：基礎通,其他貨幣均比照其進行報價的貨幣。它表示基礎貨幣相對第二種貨幣的價值。",
        "Base rate：基準利率某個國家/地區中央銀行所確定的貸款利率。",
        "Basis point：基準點通常為萬分之壹或0.01%，比如降息50個基準點即為降息0.5%。",
        "Bear market：熊市，以長時期下跌的價格為特征的市場。",
        "Bid：買入價。買家願意購買產品的最高價稱為“買入價”。亦請參閱“賣出價”。",
        "Bid-offer spread：買賣差價。產品購買價（賣出價）及售出價（買入價）之間的差價。",
        "Bid Price：買入價，該價格是市場在壹外匯交易合同或交叉貨幣交易合同中準備買入壹貨幣的價格。",
        "Bid/ Ask Spread：差價，買人與賣出價格的差額。",
        "Big Figure Quote：大數，交易員術語，指匯率的頭幾位數字。",
        "Blue chip：藍籌。藍籌企業通常地位穩固，財務穩健，更能抵禦經濟蕭條。因此藍籌股被認為更加穩定。列於某個國家/地區頂級股票指數（如英國富時100指數）的企業被視為藍籌。",
        "Book：賬本，在專業交易環境中,賬本是交易商或者交易櫃臺全部頭寸的總覽。",
        "Bollinger Bands：布林線。在技術分析中用於衡量市場波動的圖表指標，由壹條移動平均線和兩條標準差線組成。",
        "Bull Market：牛市，以長時期上漲價格為特征的市場。",
        "Bullion：貴金屬。貴金屬條或錠，如金、銀、鉑或鈀。",
        "Bundes bank：聯邦銀行，德意誌聯邦銀行。",
        "Buy limit order：買入限價訂單該附帶條件的交易訂單僅可按指定價格或更低的價格購買證券。亦請參閱“止盈訂單”。",
        "Buy position：多頭頭寸市價上漲時獲利或市價下跌時虧損的市場頭寸。",
        "Buy stop-entry order：買入止損掛單。",
        "Breakout trading：突破交易該交易策略建議壹旦價格突破指定的阻力位或支撐位則進行點差交易或差價合約交易。當價格突破阻力位時買入，當價格突破支撐位時賣出。這些策略認為，壹旦價格突破支撐或阻力位，很可能開始出現新的趨勢。",
        "Broker： 經紀商為促成買賣雙方交易充當中介角色的個人或公司，通常收取小額傭金或費用。",
    ],
    enlong:[
    ...
    zhlong:[
        "Cable：英鎊兌美元匯率,交易商針對英國英鎊的行話,指英鎊兌美元的匯率。",
        "CAC 40：在巴黎股票交易所上市的前40大公司的市值加權指數。CAC指數由Societe des Bourse Francaises發布。",
        "CAD-Canadian Dollar：加拿大元。",
        "Candlestick Chart：燭臺圖表，表示當日成交價格幅度以及開盤及收盤價格的圖表。",
        "Capital：資本。由個人或公司持有的財富（貨幣或資產）。",
        "Carry cost：持有成本。持倉產生的成本（如 納入大宗商品期貨價格的套息成本包括保險成本、存儲成本、利息費用和其他相關費用）。",
        "Carry trade：套息交易。該策略指交易者賣出低利率的特定貨幣並利用該資金來購買利率更高的其他貨幣，以獲得利率之間的差額。常見的低收益貨幣包括美元和日元，常見的高收益貨幣包括澳元和新西蘭元。",
        "Cash market：現金市場，是以期貨或期權為實際操作的金融工具的市場。",
        "Cash price：現金價格。可立即交付的資產價格。亦可稱為資產的現行實際價格。該術語通常用於股票指數，而同義術語現貨價格通常用於外匯和大宗商品價格。亦請參閱“現貨匯率”。",
        "Central bank：中央銀行，管理壹國貨幣政策並印制壹國貨幣的政府或準政府機構，比如美國中央銀行是聯邦儲備署,德國中央銀行是聯邦銀行。",
        "Channel：軌道。圖表中由兩條直線標示界限的向上或向下的趨勢。向上或向上突破軌道線表明可能出現趨勢變化。",
        "Charting：制圖。利用過去的價格圖表以及其他指標預測未來價格走勢的壹系列技巧。",
        "Chartist：圖表專家，使用圖表和圖形，解釋歷史數據,以便能找到趨勢，預測未來走勢，並協助技術分析的人。也可稱為技術交易員。",
        "CHF-Swiss franc：瑞士法郎。",
        "Cleared Funds：清算資金，能立即使用的現金，被用於支付交易。",
        "Closed position: 關單價位，外匯的交易已不再存在。壹關單過程為賣出或買進貨幣來抵消同等數量的現有交易。",
        "Close out：結清。賣出多頭倉位或買入空頭倉位進行平倉，以不再面臨市場價格變動的風險。",
        "Closing price：收盤價：閉市時可交易金融產品的最終價格。",
        "Collateral：抵押，被用來作為貸款擔保或執行保證的有價值的東西。",
        "Commission：傭金，由經紀人收取的交易費用。",
        "Confirmation：確認書、由交易雙方交換、確認交易的各項條款的交易文件。",
        "Consumer Price Index (CPI)：消費物價指數(CPI)。衡量消費者所購買商品和服務的價格變動的指標。該數據衡量由具代表性的城鎮居民所消費的各種常見商品及服務項目的價格水平隨時間的平均變化。",
        "Contagion：金融風暴，經濟危機從壹個市場蔓延至另壹個市場的趨勢。",
        "Contract (unit or lot)：成交單位或手。部分交易所的標準交易單位。對股票指數、外匯和大宗商品倉位來說，它是市場點位每次變動以基礎貨幣計值的盈利或虧損金額單位。",
        "Contract for difference (CFD)：差價合約(CFD)。差價合約 (CFD) 是壹種金融衍生產品，讓您可對標的金融資產（如股指、股票和大宗商品）的價格變動進行交易。這是交易員與供應商之間的協議，即交換某項資產從合約開口到關閉之間的價值差額。進行差價合約交易時，您並不實際擁有選擇交易的資產或金融工具，但如果市場變動符合您的預期仍可獲利。",
        "Controlled risk：受控風險。通過保證止損嚴格限制最高損失的倉位。亦請參閱“有限風險”。",
        "Contract：合約或單位，外匯交易的標準單位。",
        "Core inflation：核心通脹。剔除受價格走勢波動影響的項目後的通脹度量。比如蔬菜價格易受到季節性條件而產生變動。這些產品不在計算範圍內，因為它們的價格會偏離總體走勢，從而造成通脹度量錯誤。",
        "Corporate Action：公司行為。股份公司發起的可影響股東的任何事項。對於某些事項，股東可能或必須對公司行為做出回應或從壹系列可選行動中選出要做出的行動。公司行為示例包括股息支付、並購、股票認購權發行和股票分割。亦請參閱“股息和股票認購權發行”。",
        "Counter Currency：相對貨幣、成對貨幣中的第二個貨幣。",
        "Counterparty：交易對方，外匯交易中的其壹參與者。",
        "Country Risk：國家風險,與政府幹預相關的風險(不包括中央銀行幹預)。",
        "Cross Curreney Pairs or Cross Rate：交叉配對貨幣/交叉貨率，在外匯交易中外匯與另壹外匯之交易。",
        "Cross rate：交叉匯率。兩種貨幣之間的兌換率，但兩種貨幣均不得是報價所在國家/地區的官方貨幣。亦請參閱不涉及美元的貨幣報價。",
        "Crossed price：交叉價格。買入價超過賣出價的情況。這通常表明處於拍賣期的地點或市場發生某個事件。",
        "Cunrrency Symbol：外匯符號。",
        "Currency：貨幣，由壹國政府或中央銀行發行的該國交易單位,作為法定貨幣及交易之基本使用。",
        "Currency Pair：對貨幣，由兩種貨幣組成的外匯交易匯率。",
    ...
    zhlong:[
        "Daily charts：每日圖表。包含金融產品每日價格走勢的圖表，比如貨幣對、指數或股票。",
		"Data releases：數據發布。通常情況下會定期發布全球經濟統計數據，通常每月壹次。該數據可對金融市場產生不同的影響，取決於發布時間、所提供的經濟卓見水平以及其他因素。",
        "DAX 30：在德國法蘭克福股票交易所上市的前30大公司的市值加權指數。",
        "Day Trader：日內交易員,投機者在商品交易中的同壹交易日內先於最後交易時限清算價位。",
        "Day trading：日間交易。在同壹天或同壹個交易期內進場和退場交易的過程。",
        "Day order：當日訂單。買入或賣出金融產品的訂單，如果在下單當日沒有執行訂單將會在當日結束後自動過期。",
        "Dealer：交易員,在交易中充當委托人或者交易對方角色的人。",
        "Dealing spread：交易價差。合約買入價和賣出價之間的差價。",
        "Deficit：赤字,貿易(或者收支)的負結余,支出大於收入/收益。",
        "Delivery：交割,交易雙方過戶交易貨幣的所有權的實際交付行為。",
        "Depreciation：貶值,由於市場供需作用,貨幣價值下跌。",
        "Deposit：定金。發起和維系敞口價差賭註或差價合約買賣倉位所需的資金。由於點差交易和差價合約按保證金交易，定金僅為全部交易值的壹小部分，而非交易中全部可虧損的數額。",
        "Depreciation：貶值。資產價值下降。",
        "Derivative：衍生工具,由另壹種證券(股票、債券、貨幣或者商品)構成或衍生而來的交易。",
        "Devaluation：貶值,通常因官方公告引起的壹種貨幣幣值對另壹種貨幣幣值的刻意下調。",
        "Diversification：多元化。通過投資者交易組合的多樣化管理風險的投資戰略。由於從各不同的行業選出不同的組成部分，因此不太可能所有投資都會出現同壹方向的波動。其認為比起投資組合的單壹組成部分，投資組合整體將得出更為壹致穩定的結果。",
        "Dividends：股息。股息為由董事會決定向壹類股東分配的部分公司收益。股息可以現金、股票或其他財產的方式分配。",
        "Dove：鴿派。鴿派與鷹派對立，指鼓吹低利率是壹種經濟刺激手段、奉行傳統經濟政策的經濟政策顧問。",
        "Dow Jones Industrial Average (DOW)：道瓊斯工業平均指數 (DOW)。道瓊斯指數是美國第二個最悠久的股票市場指數，是美國股票市場整體狀況的最廣泛使用的指標。它選出美國30家藍籌國有企業並對其業績進行度量。",
        "Downtrend：下降趨勢。",
    ],
    enlong:[
    ...
    zhlong:[
        "Economic driver：經濟驅動因素。造成投資（如股票、大宗商品或物業）市價變動的經濟變動。",
        "Economic Indicator：經濟指標,由政府或者非政府機構發布的,顯示當前經濟增長率以及穩定性的統計數字。",
        "Electronic Currency Network (ECN)：電子貨幣網絡 (ECN)。用於外匯交易的虛擬交易。",
        "Elliot wave theory：艾略特波浪理論。該理論由RN Elliott提出，其為基於可預見性的假設借由識別金融產品價格走勢的特定流動和結構的技術分析方法。",
        "End of Day Order(EOD)：結束日訂單,以壹個指定的價格買入或賣出訂單。",
        "Euro：歐元。歐元區貨幣單位。",
        "European Monetary Union(EMU)：歐洲貨幣聯盟,歐洲貨幣聯盟的主要目標是要建立名為歐元的單壹歐洲貨幣。",
        "European Central Bank(ECB)：歐洲中央銀行,歐洲貨幣聯盟的中央銀行。",
        "Equity：權益。代表所有權益的股票或股份。",
        "Ex-dividend date：除權日。股份買方不再有權獲得當前股息支付的首個交易日。",
        "Exchange：交易所。證券、大宗商品、衍生品和其他金融產品交易的市場。交易所（比如股票交易所）的核心功能是確保交易公平有序並為交易所的任何證券交易提供有效的價格信息傳播。交易所給公司、政府和其他團體提供向投資大眾銷售證券的平臺。交易所可為交易者會面開展業務的實際場所或為電子平臺。",
        "Execute and eliminate order：執行和撤銷訂單。執行當前市價或更低價的限價訂單。若訂單沒有完全達到指定的訂單水平，任何余下的結余將會被取消。",
        "Execution-only stockbroker：僅執行股票經紀人。為客戶提供廉價的交易設施但不會提供有關投資方式或政策的建議、研究或提議的股票經紀人。",
        "Expiration date：到期日。特定合約交易的最後壹天。",
        "Expiration/ Expiry：到期/過期。壹些價差賭註或差價合約市場有壹個固定期限。例如期貨合約將在未來預定的日期和時間到期。到期後可以說期貨合約已過期並待交收。交收與合約到期時的達成程度有關，壹般會涉及到期時的市場情況。",
        "Exposure：風險。風險投資水平。風險越高，潛在損失或收益越大。",
    ],
    enlong:[
    ...
    zhlong:[
        "Fair value：公允價值。期貨合約對其標的現貨/現金金融產品的溢價（或貼現），壹般包含利息和股息部分。公允價值指期貨合約的合理定價，從而不會在期貨和現金中產生套利機會。",
        "Federal Deposit Insurance Corporation(FDC)：聯邦存款保險公司,美國負責管理銀行存款保險的管理機構。",
        "Federal reserve(Fed)：聯邦儲備署,美國中央銀行。",
        "Fibonacci：斐波那契交易中用來識別未來價格走勢的技術分析比率，以數學家列奧納多斐波那契 (Leonardo Fibonacci) 的名字命名。最出名的斐波納契工具是斐波納奇回調線和擴展線。",
        "Fill or kill order：全數執行或立刻取消訂單該限價訂單僅在可以於指定訂單水平全部成交時才會被執行。若沒有達到此條件訂單將會被撤銷。",
        "Fill：全數執行。執行訂單。",
        "Financial Conduct Authority (FCA)：金融行為監督局 (FCA)在英國負責監督金融服務公司的機關。金融行為監督局的作用之壹是監管證券、期權、股票、點差交易和差價合約經紀人和交易商的行為，以使客戶可以公平交易。",
        "Financing costs：融資成本。差價合約及價差賭註股票的隔夜倉位會產生倉位全額的融資成本。如果以5%的保證金建倉，隔夜融資將按全部余額進行計算。持有多頭頭寸的客戶將支付利息； 空頭頭寸的客戶可能會收到利息。",
        "First In First Out(FIFO)：根據FIFO會計法則,所有貨幣對交易頭寸必須清算。",
        "Fiscal policy：財政政策。財政政策是指政府的開銷政策，會對整體經濟產生重大影響。該政策影響到政府的收入和支出。當政府赤字（開銷大於收益）時，經濟投入將大於支出並計入國內生產總值 (GDP)。",
        "Flat/ square：持平/或者軋平—如既沒有多頭也沒有空頭,即相當於持平或者軋平。",
        "Flexible spread：靈活價差。經紀人可根據市況調整買入價和賣出價的差額。亦可稱為動態價差、浮動價差或可變價差。",
        "Floating profit/ loss：浮動損益。按當前價格計算的未平倉頭寸流動損益。",
        "Foreign Exchange：外匯，( Forex,FX)在外匯交易場中同時買入壹種貨幣並賣出另壹種貨幣。",
        "Forward：遠期交易，將在未來約定日期開始的交易。",
        "Forward Points：遠期點數，為計算遠期價格，加入當前匯率或從當前匯率中減去的點數。",
        "Free margin：建倉保證金。可用於建倉的交易賬戶資金。其按賬戶總值減所需保證金計算。",
        "FTSE 100：英國富時100指數。在倫敦股票交易所上市的前100大公司的市值加權指數。其常作為評估英國大體市場的指標。",
        "Fundamental Analysis：基本面分析，以判断金融市場未來走勢為目標，對經濟政治數據的透徹分析。",
        "Futures( Contract）：期貨，壹種在將來某個日期以特定價格交易金融工具或者商品的方式。",
    ],
    enlong:[
    ...
    zhlong:[
        "G7：7個領先工業國家:美國、德國、日本、法國、英國、加拿大、意大利。",
        "Gapping：缺口。市場交易以偏離先前交易價的價格進行而沒有出現以幹預價格進行交易的現象； 其常常（但不壹定）與閉市壹段時間後市場重新恢復交易時相關。亦請參閱“滑點”。",
        "GBP- British pound：英鎊。",
        "Gearing： 杠桿比率。杠桿比率是對所用杠桿的度量，通常用百分比表示。高杠桿交易需要的首次支出少於交易的名義價值，可被視為高風險。小規模的價格走勢可創造放大的收益或虧損，因此虧損可超過投入的定金。亦請參閱“杠桿”。",
        "Going Long：買漲,對股票、商品和貨幣作為投資或投機的購買。",
        "Going Short：賣空,賣出不屬於賣方的貨幣或金融工具。",
        "Good-for-day (day order)：即日有效訂單（即日訂單）。當天過去之前沒有被全數執行將會失效的訂單類型。亦請參閱“待建訂單”、“取消前有效”、“全數執行”。",
        "Good-till-cancelled (GTC)： 取消前有效 (GTC)。與即日有效訂單不同，取消前有效訂單除非在全數執行前被取消，否則將會在賬戶上壹直等待全數執行。亦請參閱“待建訂單”、“即日有效訂單”、“全數執行”。",
        "Greenback：綠幣。美元的俚語。",
        "Gross Domestic Product (GDP)：國內生產總值,壹國的總生產量,收入及支出。",
        "Gross National Product：國民生產總值,國內生產總值加上國際投資,交易收入。",
        "Guaranteed stop-loss order (GSLO)：保證止損訂單。該止損訂單可在市場觸及“止損”價時進行買賣，從而限制虧損。與標準止損訂單不同，保證止損訂單不受滑點或缺口影響且能保證買賣中將要平倉的價格。向我們下達保證止損訂單時需要支付費用；不過如果保證止損訂單沒有被執行而出現平倉，我們會返還100%的費用。",
    ...
    zhlong:[
        "Hawk, hawkish：鷹派。支持較高利率可控制通脹或遏制經濟的快速增長觀點的經濟政策顧問。亦請參閱“鴿派”。",
        "Hedge：對沖,用於減少投資組合價值易變性的投資頭寸或者頭寸組合。",
        "Hit the bid：達到買價,在壹買價價位上交易被執行。",
        "Holding costs：持倉成本。超過紐約時間17:00後仍未平倉會產生持倉成本。這些持倉成本將基於倉位總規模計算。亦請參閱“融資成本”。",
    ],
    enlong:[
    ...
    zhlong:[
        "Illiquid market：非流動市場。買賣盤記錄中總成交量較小的市場。在非流動市場，少量業務通常以不成比例的金額改動價格，從而買入價和賣出價可能相距甚遠。",
        "Illiquidity：流動性不足。由於要售出的資產需求不足，從而難以用現金兌換資產的情況。我們作為做市商可通過持續報出買賣價差提供流動性。亦請參閱“流動性”。",
        "Index：指數。諸如富時100或標準普爾500的指數，是對壹部分股市繁榮度或價值的度量。其通常采用加權平均數從所選股票的價格進行計算。無法直接投資指數； 但投資者可以投資追蹤指數走勢的基金或其他產品。",
        "Industrial production：英國工業生產指數。衡量英國工業板塊（包括制造業、采礦業和公共事業）產出變動的月度經濟指標。",
        "Inflation：通貨膨脹,壹種經濟狀態,其中消費品物價上漲,進而導致貨幣購買力下降。",
        "Inflation rate：通脹率。對指定期限（比如壹年或壹個日歷季度）所發生通脹的度量。通脹率顯示商品和勞務壹般價格的上升速度。",
        "Initial Margin：原始保證金,為進入頭寸所需的期初抵押存款,用於擔保將來業績。",
        "Initial Public Offering (IPO)： 首次公開招股 (IPO)。壹家公司首次在股市上市的過程。向投資大眾發行股票是壹種用於進壹步擴張的集資方式。也稱為“新發行”。",
        "Interbank Rates：銀行同業買賣匯率,大型國際銀行向其他大型國際銀行報價時所按照的外匯匯率。",
        "Interest：權益。為反映擁有或收取點差交易或差價合約倉位所控制股權名義金額的經濟影響而做出的現金調整。",
        "Intervention：幹預,由中央銀行所采取的行動,以此調整該貨幣的價值。",
        "Intraday trading：即日交易。同壹交易日做出建倉和平倉的交易。",
        "Instant execution：即時執行。按屏幕顯示價格執行的訂單。若價格不可用，可重新報價作為新的雙向報價，投資者可按該報價重新提交訂單或取消訂單。",
    ],
    enlong:[
    ...
    zhlong:[
        "Japanese candlestick charts：日本蠟燭圖。日本蠟燭圖類似於條形圖，每根“蠟燭”顯示該時期的開盤價、收盤價、高價和低價。蠟燭為綠色或紅色，收盤價高於開盤價時為綠色，收盤價低於開盤價時為紅色。主體“蠟燭”表示開盤價和收盤價之間的範圍，“燭芯”顯示價格的高低點。",
        "JPY- Japanese Yen：日元。",
    ],
    enlong:[
    ...
    zhlong:[
        "Last dealing day：最後交易日。可在特定市場交易的最後壹天。其不可與該市場的交收日為同壹天。",
        "Last roll-over date：最後展期日期。特定遠期交易或訂單可人工展現、取消或重新選擇自動展期（詳見產品庫）的最後可行日期和時間。",
        "Last trade opening date：最後交易開放日。可在特定遠期市場進入或延續交易或修改現有訂單（包括待執行訂單）的最後可行日期和時間。",
        "Leading Indicators：領先指標,被認為可預測未來經濟活動的經濟變量。",
        "Leverage：杠桿,也稱為保證金,為實際交易的金額與要求保證金的比例。",
        "LBOR：倫敦銀行間拆放款利率。最大型國際銀行間互相借貸的利率。",
        "Libor：（倫敦銀行同業拆放利率）。倫敦銀行同業之間就短期貸款的利率，其為許多其他利率收費/產品的重要影響基準。單壹貨幣計價有相應的倫敦銀行同業拆放利率。其為十種貨幣而設，每種貨幣有15種報價期（包括隔夜和12個月），每個工作日做出150個利率。",
        "Limit Order：限價訂單,以指定價格或低於指定價格買入,或者以指定價格或高於指定價格賣出的訂單。",
        "Limited risk：有限風險。嚴格限制最大虧損的交易。亦請參閱“受控風險”。",
        "Line charts：折線圖。用線連接壹系列數據點的折線圖，通常為以往的收盤價。它是金融市場中最常使用的基本圖表類型。",
        "Liquidation：清算,通過執行壹筆抵銷交易,以結清壹份未結頭寸。",
        "Liquidity：流動性與非流動性市場,市場能夠輕松買人或賣出而不會影響價格穩定的能力。",
        "Log file：日誌文件。交易活動的持續記錄日誌。",
        "Long Position：多頭,購人的工具數量多於賣出數量的頭寸。",
        "Long-term trading：長期交易。就差價合約產品或價差賭註而言，長期交易指未平倉頭寸平均期限在壹周至幾個月之內的策略。",
        "Loonie：加拿大元的俚語。",
        "Lot：單,壹用來衡量外匯交易數量的單位。交易的價值總是相對於壹整數“單”而言。",
        "Lot size：每手數量。金融產品的標準數量，比如每份合約的基本貨幣及標的資產或股份。",
        "Liquid market：流動市場流動市場的大型交易雙向業務的成交量充足，不會對價格產生重大影響或根本不會產生影響。該市場通常表現出收緊的買賣價差。",
        "Liquidity providers：流動性提供者流動性提供者為在指定資產類別充當做市商的個人或機構。在全球外匯中，大部分全球流動性由眾多大牌投資銀行（稱為壹級流動性提供者）提供。",
    ...
    zhlong:[
        "Major currency pairs：主要貨幣對。外匯市場最活躍的交易貨幣對，包括歐元/美元、美元/日元、英鎊/美元和美元/瑞郎。",
         "Margin：保證金，客戶必須存入的抵押金，以便承擔由反向價格運動引起的任何可能損失。",
         "Margin call：追加保證，經紀人或者交易員發出的，對額外資金或者其他抵押的要求，使保證金額到達必要數量，以便能保證向不利於客戶方向移動的頭寸的業績。",
         "Market capitalisation (MCAP)： 市價總值 (MCAP)。市價總值指公司股票價值。該數值由已發行股份數目乘以當前股份價格得出。投資者會發現在確定公司規模時市價總值很有用處。",
         "Market execution：市價執行。不經重新報價按市場上的最優價格執行的訂單。",
         "Market Make：運營者，提供價格，並準備以這些所述的買賣價格買入或者賣出的交易員。",
         "Market Risk：市場風險，與整體市場相關的風險，並且不能以對沖或者持有多種證券等方式加以分散。",
         "Market order：市價訂單。",
         "Market-making：做市。根據投機、期望和供需報出買入價和賣出價的過程。",
         "Mark-to- Market：至市價，交易商以下列兩種方式計算各自持有頭寸：自然增長或者調至市價。",
         "Maturity：到期日，壹金融工具的交易日或到期日。用來指明交易方向和規模而非價格的訂單。這可以保證訂單盡快完成。",
         "Medium-term trading：中期交易就差價合約產品和價差賭註而言，指交易員準備持倉超過壹天但未平倉頭寸平均期限不超過幾周的策略。",
         "Mid-price：中間價。按買入價加賣出價除以二計算。",
         "Monetary policy：貨幣政策。中央銀行在經濟中設定利率和控制資金量的行為，旨在將通脹和失業率控制在可接受的水平。",
         "Moving Average Convergence Divergence (MACD)：平滑異同移動平均線 (MACD)。技術分析中用來表示可能出現看漲或看跌走勢逆轉的圖表指示。",
         "Moving average：移動平均線。以圖形的方式表示特定時間段的價格加以平均。移動平均線可以幫助識別走勢、進入點和潛在的目標停止水平。",
    ...
    zhlong:[
        "NASDAQ： 納斯達克。納斯達克是美國第二大的股票交易所，有許多科技公司在納斯達克上市已久，比如微軟。納斯達克的走勢對英國市場（特別是科技、傳媒和電話通訊公司的techMARK指數）影響重大。",
        "Net Position：價位，還未由相反交易抵消的買/賣的貨幣數量。",
        "New issue：新發行。壹家公司首次在股市上市。向投資大眾發行股票是壹種用於進壹步擴張的集資方式。也稱為“首次公開招股 (IPO)”。",
        "New York Stock Exchange (NYSE)：紐約證券交易所 (NYSE)。美國最大和最悠久的股票交易所。",
        "Nikkei 225：日經225。在東京股票交易所上市的前225大股票的價格加權指數。",
        "Non-dealing desk (NDD)：無交易員模式 (NDD)，該執行模式可直接與眾多市場流動性提供者直接交易，以獲得最有競爭力的買入價和賣出價。",
        "Non-farm payrolls： 非農就業數據。美國勞工部通常在每月第壹個星期五發布的重要經濟指標。其表示所有行業就業人口數量，但不包括農業、當地政府、私人及非盈利經濟機構。每月數據可發生重大變動，通常約在發布時會導致外匯貨幣對（比如歐元/美元）的大幅波動。壹般來說，數值高被認為是有利（或看漲）美元，而數值低被認為是不利（或看跌）美元。",
    ...
    zhlong:[
        "OCO (one cancels the other)：OCO（二選壹訂單）。同壹時間對同壹股票下達限價賣出訂單和賣出止損訂單。當執行其中壹個訂單時，另壹個訂單將自動取消。也適用於限價買入和買入止損訂單。",
        "Offer：發盤價。由發盤或遞盤組成的當前市價。在兩種價格中，遞盤價總是高於發盤價。",
        "Offer(ask) price：賣出價，在賣出時，賣方願意依照的價格或匯率。參看買入價。",
        "Offsetting Transaction：抵消交易，用於撤銷或者抵消未結頭寸的部分或全部市場風險的交易。",
        "One Cancels the Other Order(OCO)：選擇性委托單，壹種突發性訂單，執行訂單的壹部分將自動撤銷訂單的另壹部分。",
        "Online trading： 在線交易。通過經紀人（如CMC Markets的在線交易平臺）經由互聯網買賣金融產品的行為。",
        "Open Order：開放訂單,在市場價格向指定價位移動時買入或賣出的訂單。",
        "Open Position：未結頭寸，尚未撤銷或者清算的交易，此時投資者利益將受外匯匯率走勢的影響。",
        "Option：期權。在壹定期限內按指定價格（“行使價”）買入（“看漲期權”）或賣出（“看跌期權”）壹定數量的指定股票、大宗商品、貨幣或指數的權利但非義務。對持有人而言，潛在損失僅限於獲取期權支付的價格。期權若未被行使將會到期失效。",
        "Order：指令，給予交易在特定日期執行的指示。",
        "Order / order to open：訂單/建倉訂單。客戶指示經紀人/交易員當觸及指定價格時的買賣指示。訂單在被客戶執行或取消前壹直有效。",
        "Order book：買賣盤記錄。當觸及指定買入價或賣出價時，新近訂單會自動按訂單進行記錄。自1997年10月20日起英國富時100指數股票壹直在電子買賣盤記錄上交易。",
        "Out-of-hours： 在正式交易時間以外的交易。在主要市場（如英國100或美國30）主要開放時間以外的時間進行的交易。",
        "Over the Counter(OTC)：櫃臺市場，用於描述任何不在交易所進行的交易。",
        "Overnight Position：隔夜交易，直到第二個交易日仍保持開放的交易。",
        "Oscillator：搖擺指標。在圖表分析中顯示走勢逆轉發生的可能性的先行指標。",
    ],
    enlong:[
    ...
    zhlong:[
        "Pips：點，在貨幣市場中運用的術語，表示匯率可進行的最小增幅移動。根據市場環境，正常情況下是壹個基點。",
        "Pivot points：樞軸點。樞軸點在技術分析中使用前壹個時期的最高、最低和收盤計算當前期間的支撐位和阻力位。",
        "Political risk：政治風險，壹國政府政策的變化，此種變化可能會對投資者的頭寸產生負面效果。",
        "Portfolio：投資組合。個人或公司持有的投資組合。",
        "Position：頭寸（倉位），是壹種以買入或賣出表達的交易意向。",
        "Position margin：倉位保證金。價差賭註者或差價合約交易員新建倉位需要支付的保證金凈值。",
        "Position sizing：倉位規模。特定投資組合的倉位規模。其與風險管理技巧有關，投資者計算每個新倉規模，以便倉位可能遭受的最大損失不會超過其資本的壹定數額或比例。",
        "Premium：升水，在貨幣市場中，升水指為判断遠期或期貨價格而向即期價格中添加的點數。",
        "Price depth：價格深度。",
        "Price Transparency：價格透明度，每壹位市場參與者都對報價說明有平等的訪問權。",
        "Producer Price Index (PPI)：生產價格指數 (PPI)。衡量生產者售出成品和服務的價格的統計數據。",
        "Profit /Loss or\“PL\" or Gain/Loos：利潤/損失，實際操作時，完結交易的兌現利潤或損失，再加上被調至市價的理論“未兌現”利潤或損失。",
        "Purchasing Managers Index (PMI) ：采購經理人指數(PMI)。由眾多制造企業經理完成調查而創建的經濟活動指標。它以圖片的形式顯示制造業的經濟條件，常被投資者用於預測壹個國家/地區經濟的未來國內生產總值。",
    ...
    zhlong:[
        "Quantitative easing：量化寬松。當傳統貨幣政策措施（如削減利率）不湊效時中央銀行為刺激經濟而采取的措施。中央銀行以電子方式在其自己的銀行賬戶設立資金以購買以前發行的政府債券，加上私營部門和不良的資產（這樣公司能籌集資金）。這有助於創造更多的市場交易和流動性，以幫助刺激經濟。",
        "Quarterly CFDs： 季度性差價合約產品。每隔三個月到期的期貨類型。通常會報出未來兩個或三個季度的價格。亦請參閱“展期”。",
        "Quote：報價。壹種指示性市場價格,顯示在任何特定時間,某壹證券最高買入和或最低賣出的有效價格。",
        "Quote currency：計價貨幣。貨幣對中的第二個貨幣（如美元是英鎊/美元的計價貨幣）。亦請參閱“基本貨幣”或“可變貨幣”。",
    ],
    enlong:[
    ...
    zhlong:[
        "Rally：上升幅度，從壹階段的價位下降開始回升。",
        "Range：波動範圍，在將來的交易記錄中，壹指定階段的最高價與最低價的差別。",
        "Rate：匯率，以別種貨幣計的壹種貨幣價格。",
        "Realised profit/ loss：實現盈利/虧損。平倉時賺取或虧損的金額。實現盈利或虧損將計入賬戶現金余額或從中扣除。",
        "Relative strength index (RSI) ：相對強弱指標 (RSI)。技術分析使用的圖表指標。其可識別走勢將要達到當前方向盡頭的時間以及超賣和超買市場條件。",
        "Requote： 重新報價。當執行訂單所要求的價格不再有效時會進行重新報價，從而得出不同的報價。在快速流動的市場可發生重新報價。",
        "Resistance level：阻力位，技術分析術語，表示貨幣無力超越的某壹具體價位。",
        "Retail sales： 零售銷量。零售商向顧客售出耐用品和非耐用品的總數。該統計數據在很大程度上不包括服務。",
        "Revaluation：再估價匯率，是交易商在進行每日結算時，為確定當日利潤和虧損而使用的市場匯率。",
        "Rights issue：股票認購權發行。公司以有利優惠的價格向現有股東額外發行股份，通常是為了籌措新的資金用於進壹步發展或為新的收購融資。按145p的五得二股票認購權發行指現有股東有權按每持有五份股份可以每份收購股份145p的新成本額外增購兩股。",
        "Risk：風險，風險暴露在不確定變化中，收益的多變性；更重要的是，少於預期收益的可能性。",
        "Risk Management：風險管理，利用金融分析與交易技術來減少和/或控制不同種類的風險。",
        "Rollover：展期。平掉到期的期貨倉位並在下壹個可交易期限重新建倉。在外匯中，該流程的價值按兩種貨幣的利率差計量。展期通常需要支付小額費用。",
        "Round Trip：雙向交易，買和賣壹指定數量之貨幣。",
        "Running profit/loss：可得盈利/虧損，其表示未平倉頭寸的表現情況：若按現行市價平倉將會得出多少未實現收益或虧損額。",
],
    enlong:[
    ...
    zhlong:[
        "S&P 500： 標普500。在紐約證券交易所 (NYSE) 或納斯達克上市的前500強公司的市價總值加權指數。通常用作美國市場情緒的度量。",
        "Scalping：超短線交易法。該交易策略涉及做出短期交易（有時候低於壹分鐘），通常為了嘗試和捕捉微小價格走勢。",
        "Sector：板塊。市場不同的子集，所組成的股份性質類似。股票通常根據公司的業務被分到不同的板塊。比如英國富時100指數擁有銀行、油氣和制造板塊。",
        "Sell limit / limit sell：限價賣出訂單。指金融產品的條件性交易訂單，僅可按指定價或更高價售出。",
        "Sell stop：賣出止損。按低於下單時的價格建空頭倉位的訂單。其受價格深度階梯影響，可能會滑落至當前市價。",
        "Selling short：賣空。賣出非本身所有的股份並希望在結清合約前股價下跌的操作。若價格下跌，可按較低價格買入股份賺取差額。亦請參閱“空頭交易”。",
        "Settlement：清算結算，壹筆交易並進入記錄的過程。",
        "Shorting：空頭交易。該交易形式為首次交易（如點差交易或差價合約倉位）賣出倉位並希望市場下跌。之後通過買入交易平倉。若價格下跌則盈利，價格上漲則虧損。在交易外匯時它是指根據計價貨幣賣出基本貨幣。",
        "Short Position：空頭頭寸，由賣出空頭而產生的投資頭寸。",
        "Slippage： 滑點。訂單請求水平和訂單實際執行價格的差額。市價變動迅速或有缺口時，在波動變強期間會產生滑點。亦請參閱“全數執行”和“缺口”。",
        "Spot position：即期價格，當前市場價格。",
        "Spot price：即期價格。即時結算或交付貨幣、指數、大宗商品或股份的報價（支付和交付產品的款項）。其為特定時間可買賣大宗商品或貨幣的當前價格。",
        "Spot rate：即期匯率。即時結算的匯率。",
        "Spread：價差，買賣價格之間的差價。",
        "Spread charts：點差表。點差表以雙線圖表格式繪制買賣價格。藍色線表示買入價，橙色線表示賣出價； 陰影區域為兩個價格的差別或稱為“點差”。",
        "Square：軋平，沒有多頭也沒有空頭，即相當於持平或者軋平。",
        "Sterling：英國英鎊的另壹名稱。",
        "Stochastic：隨機指標。在技術分析中用於確定可能的走勢逆轉的圖表指標，以表現出超買或超賣市場狀況。",
        "Stock exchange：股票交易所。證券交易市場。",
        "Stock index：股票指數。股票指數為編入壹個由許多股票組合的總價格，以使投資者容易跟進特定組別股票的表現。",
        "Stockbroker：股票經紀人。交易所成員公司，向公眾提供建議和交易服務，同時也使用自己的賬戶進行交易。",
        "Stop entry order：止損掛單。止損掛單可在設定期限內按選定的目標價格進場交易。買入止損掛單是指以高於當前市價的價格交易的訂單。賣出止損掛單是指以低於當前市價的價格交易的訂單。止損掛單通常受滑點影響。",
        "Stop loss: 止損。下達訂單在價格觸及指定止損價格時自動平倉。止損訂單旨在限制倉位虧損。但是由於市場缺口或滑點的原因，根據市場狀況交易可能會按稍微偏離的價格退場，不能完全保證止損。也稱為止損訂單。",
        "Stop Loss Order：停止損失訂單，以協議價格買入/賣出的訂單。",
        "Stop order：止損訂單。價格觸及特定點位時平倉的訂單。",
        "Strike price：行使價。數位 100結清須遵循的目標價格；期權交易中可行使或結清合約的價格。",
        "Support Levels：支撐位，壹技術性分析中的術語，表示壹貨率在指定最高與最低價位間能自動調整自身走勢。",
        "Swap：掉期，壹貨幣掉期為同時以遠期貨幣匯率賣/買壹相同數量貨幣。",
        "Swissy：瑞郎，瑞士法郎的俚語。",
    ],
    enlong:[
    ...
    zhlong:[
        "Take profit： 獲利。以相比下單價格更可盈利的價格平掉未平倉頭寸的訂單。",
        "TechMARK：集結市場上全部科技公司的市場。techMARK有其專門的指數：FTSE techMARK 100和FTSE techMARK All-share。",
        "Technical Analysis：技術分析，通過分析諸如圖表、價格趨勢、交易量等市場數據，試圖預報未來市場活動的做法。",
        "Tick：替克，貨幣價格的最小單位變化。",
        "Tomorrow Next(Tom/Next)：明日次日，為下壹日交割同時買入和賣出壹種貨幣。",
        "Trade balance：貿易差額。壹個國家/地區商品和勞務（如汽車、電子產品、紡織品、銀行業和保險業）進出口的差額。",
        "Trade size：交易規模。正在交易的相關倉位的規模。其支配市場價格每次走動交易的盈利或虧損量。",
        "Trailing stop：移動止損訂單。移動止損訂單是特殊類型的止損訂單，當市場走勢有利時止損點也隨著市價移動。",
        "Transaction Cost：交易成本，與買入或賣出壹款金融工具相關的成本。",
        "Transaction Date：交易日，交易發生的日期。",
        "Treasury： 國債。政府發行的債券。由英國政府發行的債券被稱為金邊債券，通常所說的“英國國債”。",
        "Trend lines：趨勢線。圖表中繪制顯示大體趨勢的直線。在呈上升的趨勢中，下面畫的線充當支撐位； 在呈下降的趨勢中，上面畫的線充當阻力位。壹旦資產突破趨勢線，趨勢被認為無效。",
        "Trend：走勢。價格走向的大體趨勢。",
        "Turnover：交易額，指定時期內的交易量或交易規模。",
        "Two- Way Price：雙向報價，同時提供壹項外匯交易的買入和賣出報價。",
    ],
    enlong:[
    ...
    zhlong:[
        "Underlying：標的物。在衍生品交易中（如差價合約產品）使用的術語。衍生品這壹金融產品的價格來自於（衍生於）各類資產。標的物為金融產品（如股票、期貨、大宗商品、貨幣、指數），衍生物的價格以標的物為基礎。",
        "Unemployment claims： 失業救濟金認領人數。這壹統計數字表示在過去的壹周內首次申請失業保險的人數。這是美國最早的就業相關經濟數據發布。",
        "Unrealized Gain//Loss，未兌現盈利/損失，現價的為開市價位的理論上的盈利/損失，由經紀人單獨對其做決定。",
...
enlong:[
    ...
    zhlong:[
        ...
        "Variation Margin：變動保證金，由於市場波動，經紀人向客戶提出的附加保金要求。",
        "Volatility(vol)：易變性，在特定時期內市場價格變動的統計計量。",
        "VWAP：成交量加權平均價格 (VWAP) - 按特定價格對交易成交量下的金融產品進行定價的方法。",
    ],
    enlong:[
    ...
    zhlong:[
        "Wall Street：華爾街，對美國最大的股票交易所紐約證券交易所 (NYSE) 的叫法，這壹叫法廣為人知。",
        "Whipsaw：鋸齒，此詞條用於說明壹種高速變動的市場狀態，即在劇烈價格周期之後又緊接著出現壹個反向的劇烈價格變動周期。",
        "Working an order：處理訂單，對仍未執行的訂單進行處理的過程，亦稱為待執行訂單。",
    ],
    enlong:[
    ...
    zhlong:[
        "Yard：十億的另壹種說法。",
        "Yield：收益，投資所得收入回報。收益的類型很多，並在某些情況下各類型收益計算方法不盡相同。收益指證券所得股息或利息，通常為年度數據。",
        "Yuan：元，中國貨幣的基本單位。",
    ],
    enlong:[
        "Yard: Billion.",
